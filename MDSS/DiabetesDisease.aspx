<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiabetesDisease.aspx.cs" Inherits="MDSS.DiabetesDisease" %>
                ...
                <div id="box">
                    ...
                    <table>
                        ...
                        <tr style="height: 50px">
                            ...
                            <td>
                                <BDP:DateRequiredValidator ID="DateRequiredValidator1" runat="server" ControlToValidate="BasicDatePicker1"
                                    ErrorMessage="Date is required"></BDP:DateRequiredValidator>
                                &nbsp; &nbsp;
                            </td>
                        </tr>
                        <tr style="height: 50px">
