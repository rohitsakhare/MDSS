<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiabetesDiseaseChart.aspx.cs" Inherits="MDSS.DiabetesDiseaseChart" %>
                ...
                <div id="box">
                    ...
                    <table>
                        ...
                        <tr>
                            <td colspan="3">
                                <br />
                                <asp:Label ID="Label1" runat="server" Text="Cart Result"></asp:Label>
                                <br />
                                &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<br />
                                &nbsp;&nbsp;
                        ...
                        <tr>
                            <td colspan="3">
                                <br />
                                <asp:Label ID="Label2" runat="server" Text="ID3 Result"></asp:Label>
                                <br />
                                &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<br />
                                &nbsp;&nbsp;
